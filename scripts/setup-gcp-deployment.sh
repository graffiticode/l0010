...
echo "🚀 L0010 GCP Deployment Setup"
echo "=============================="
...
if [ "$DEPLOY_NOW" = "y" ]; then
    ...
    if command -v docker &> /dev/null; then
        ...
        docker build -t gcr.io/$PROJECT_ID/l0010:initial .
        docker push gcr.io/$PROJECT_ID/l0010:initial

        # Deploy to Cloud Run
        gcloud run deploy l0010 \
            --image gcr.io/$PROJECT_ID/l0010:initial \
            --platform managed \
            --region us-central1 \
            --port 50010 \
